...
(function(e, t) {
  ...
  i.rgb.xyz = function(e) {
    ...
    var n = 0.4124 * t + 0.3576 * r + 0.1805 * a;
    var i = 0.2126 * t + 0.7152 * r + 0.0722 * a;
    var o = 0.0193 * t + 0.1192 * r + 0.9505 * a;
  ...
  i.xyz.rgb = function(e) {
    ...
    var i;
    var o;
    n = 3.2406 * t + -1.5372 * r + -0.4986 * a;
    i = -0.9689 * t + 1.8758 * r + 0.0415 * a;
    o = 0.0557 * t + -0.2040 * r + 1.0570 * a;
    n = n > 0.0031308 ? 1.055 * Math.pow(n, 1.0 / 2.4) - 0.055 : 12.92 * n;
    i = i > 0.0031308 ? 1.055 * Math.pow(i, 1.0 / 2.4) - 0.055 : 12.92 * i;
    o = o > 0.0031308 ? 1.055 * Math.pow(o, 1.0 / 2.4) - 0.055 : 12.92 * o;
  ...
  i.rgb.hex = function(e) {
    var t = ((0xFF & Math.round(e[0])) << 16) + ((0xFF & Math.round(e[1])) << 8) + (0xFF & Math.round(e[2]));
  ...
  i.gray.hex = function(e) {
    var t = 0xFF & Math.round(e[0] / 100 * 255);
    var r = (t << 16) + (t << 8) + t;
  ...
  Color.prototype = {
    ...
    dark: function() {
      var e = this.values.rgb;
      var t = (299 * e[0] + 587 * e[1] + 114 * e[2]) / 1000;
      return t < 128;
    },
    light: function() {
      return !this.dark();
    ...
    greyscale: function() {
      var e = this.values.rgb;
      var t = 0.3 * e[0] + 0.59 * e[1] + 0.11 * e[2];
    ...
    mix: function(e, t) {
      var r = this;
      var a = e;
      var n = void 0 === t ? 0.5 : t;
      var i = 2 * n - 1;
      var o = r.alpha() - a.alpha();
      var s = ((i * o === -1 ? i : (i + o) / (1 + i * o)) + 1) / 2.0;
      var l = 1 - s;
  ...
  var P = {
    ...
    easeInOutElastic: function(e) {
      ...
      t = r / (2 * Math.PI) * Math.asin(1 / a);
      if (e < 1) {
        return a * Math.pow(2, 10 * (e -= 1)) * Math.sin((e - t) * (2 * Math.PI) / r) * -0.5;
      }
      return a * Math.pow(2, -10 * (e -= 1)) * Math.sin((e - t) * (2 * Math.PI) / r) * 0.5 + 1;
    },
    ...
    easeInOutBounce: function(e) {
      if (e < 0.5) {
        return 0.5 * P.easeInBounce(2 * e);
      }
      return 0.5 * P.easeOutBounce(2 * e - 1) + 0.5;
    }
  };
  var A = {
    effects: P
  ...
  function _steppedInterpolation$1(e, t, r, a) {
    return {
      ...
      y: 'middle' === a ? r < 0.5 ? e._model.y : t._model.y : 'after' === a ? r < 1 ? e.y : t._model.y : r > 0 ? t._model.y : e._model.y
    };
  }
  ...
  var Me = _e.extend({
    ...
    draw: function() {
      ...
      var t = this._view;
      var r = 'inner' === t.borderAlign ? 0.33 : 0;
      var a = {
        x: t.x,
        y: t.y,
  ...
  var ir = er.extend({
    ...
    draw: function() {
      ...
      var n = Math.abs(t.opacity < 1e-3) ? 0 : t.opacity;
  ...
  var core_helpers = function() {
    ...
    wr.getHoverColor = function(e) {
      return e instanceof CanvasPattern || e instanceof CanvasGradient ? e : wr.color(e).saturate(0.5).darken(0.1).rgbString();
    };
  };
  var kr = {};
  var Mr = k.exports;
    ...
    _computeGridLineItems: function(e) {
      ...
      for (p = 0; p < u; ++p) {
        ...
        if (p === t.zeroLineIndex && a.offset === o) {
          ...
          F = n.zeroLineBorderDashOffset || 0.0;
        } else {
          C = Or(n.lineWidth, p, 1);
          T = Or(n.color, p, 'rgba(0,0,0,0.1)');
          D = n.borderDash || [];
          F = n.borderDashOffset || 0.0;
        }
  ...
  function generateTicks(e, t) {
    ...
    g = Math.ceil(f / d) * d;
    if (n) {
      if (!jr(s) && Nr.almostWhole(s / d, d / 1000)) {
        v = s;
      }
      if (!jr(l) && Nr.almostWhole(l / d, d / 1000)) {
        g = l;
      }
    }
    p = (g - v) / d;
    if (Nr.almostEquals(p, Math.round(p), d / 1000)) {
      p = Math.round(p);
    } else {
      p = Math.ceil(p);
    }
  ...
  var Va = Ba.extend({
    ...
    draw: function() {
      ...
      if (e.isHorizontal()) {
        ...
        h = s + (u - s) / 2;
        f = u - s;
        o = Math.PI * ('left' === r.position ? -0.5 : 0.5);
      }
      t.save();
      t.translate(d, h);
      t.rotate(o);
