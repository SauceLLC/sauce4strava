/* global addTests, sauce, assertEqual, assertDefined, assertNear */
...
(function () {
    ...
    addTests([
        ...
        function test_velocity_search_flat_zero_nodrag_glass() {
            ...
            assertNear(estimates[0].power, 0);
            assertNear(estimates[0].velocity, 299792458, {epsilon: 10000000});
        },
        ...
        function test_velocity_search_downhill_huge_negative() {
            ...
            assertNear(estimates[0].watts, -200000, {epsilon: 0.0001});
        },
        function test_velocity_search_odd_mismatch() {
            const estimates = sauce.power.cyclingPowerVelocitySearch({
                power: 43,
                slope: 0.012,
                weight: 86.2,
                crr: 0.0065,
